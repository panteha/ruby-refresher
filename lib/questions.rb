...
def get_first_half_of_string(string)
  string[0, (string.size / 2.0).round ]
...
def separate_array_into_even_and_odd_numbers(array)
  ...
  array.map do |element|
    odd_arr << element if element.odd?
      even_arr << element if element.even?
  end
...
def number_of_elements_that_are_palindromes(array)
  ...
  array.count{|element| palindrome?(element)}
end

# return the shortest word in an array
def shortest_word_in_array(array)
  array.sort_by{|element| element.size}[0]
end

# return the shortest word in an array
def longest_word_in_array(array)
  array.sort_by{|element| element.size}[-1]
end
